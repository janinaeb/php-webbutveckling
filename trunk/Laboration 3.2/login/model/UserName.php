...
class UserName {
	...
	public static function isUsernameTooShort($string) {
	...
	public static function usernameContainsTags($string) {
		if (\Common\Filter::hasTags($string) == true) {
			return true;
		}
		return false;
	...
	public static function isUsernameTooLong($string) {
		if (strlen($string) > self::MAXIMUM_USERNAME_LENGTH) {
			return true;
		}
		return false;
	}
